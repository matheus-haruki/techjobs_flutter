...
class RegistrationEmpresaScreen extends StatefulWidget {
  ...
  @override
  _RegistrationEmpresaScreenState createState() => _RegistrationEmpresaScreenState();
}
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      LabelPadrao(texto: ' Nome da Empresa:'),
                      TextField(
                        style: kInputStyle,
                        onChanged: (value) {},
                        decoration: kTextFieldDecorationEmpresa.copyWith(hintText: 'Digite o nome da empresa', prefixIcon: Icon(Icons.person)),
                      ),
                      ...
                      TextField(
                        ...
                        decoration: kTextFieldDecorationEmpresa.copyWith(hintText: 'Digite seu e-mail'),
                      ),
                      SizedBox(height: 12.0),
                      LabelPadrao(texto: ' CNPJ:'),
                      TextField(
                        style: kInputStyle,
                        ...
                        decoration: kTextFieldDecorationEmpresa.copyWith(hintText: 'Digite o CNPJ', prefixIcon: Icon(Icons.business)),
                      ),
                      SizedBox(height: 12.0),
                      ...
                      TextField(
                        ...
                        decoration: kTextFieldDecorationEmpresa.copyWith(
